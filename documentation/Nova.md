...
> Nova is an OpenStack project designed to provide power massively scalable, on demand, self service access to compute resources. [Nova](http://docs.openstack.org/developer/nova/)
